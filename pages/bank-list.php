        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-1"><a  href="/slmd/pages?page=bank-new" class="btn btn-primary waves-effect waves-light">New</a></div>
                </div>
                </div>
                    ...
                    <div class="col-sm-12 table-responsive">
                        <table class="table table-hover">
                            ...
                            foreach($result as $row){ 
                                ++$count;
                                $id = $row["Id"];
                                $edit_page = "/slmd/pages?id=$id&page=bank-edit";
                                $delete_page = "/slmd/services/function.php?id=$id&action=bank-delete";
                                ?>
                                <tr>
