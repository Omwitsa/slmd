<?php include '../services/database_connection.php'; 
    $query = "SELECT * FROM business_type WHERE Id = $id;";
                ...
                <form action="/slmd/services/function.php" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-md-10">
                            ...
                            <input type="hidden" class="form-control" name="btn_action" id="btn_action" value="business-type-edit">
                        </div>
                        <div class="col-md-1">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                        </div>
                        <div class="col-md-1">
                            <a href="/slmd/pages?page=business-type-list" class="btn btn-secondary waves-effect waves-light">Back</a> 
                        </div>
                    </div>
                </form>
                </div>
