                ...
                <form action="/slmd/services/function.php" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-md-10">
                            ...
                            <input type="hidden" class="form-control" name="btn_action" id="btn_action" value="group-edit">
                        </div>
                        <div class="col-md-1">
                            <button type="submit" class="btn btn-primary waves-effect waves-light">Submit</button>
                        </div>
                        <div class="col-md-1">
                            <a href="/slmd/pages?page=group-list" class="btn btn-secondary waves-effect waves-light">Back</a> 
                        </div>
                    </div>
                </form>
                </div>
